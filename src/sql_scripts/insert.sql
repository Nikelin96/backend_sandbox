...
-- Inserting cost for blueprints
INSERT INTO storage (type, wood, food, gold, stone) VALUES ('expense', 10, 5, 15, 0); -- Spearmen Blueprint
INSERT INTO storage (type, wood, food, gold, stone) VALUES ('expense', 5, 2, 10, 0);  -- Spear Blueprint
INSERT INTO storage (type, wood, food, gold, stone) VALUES ('expense', 3, 2, 8, 0);   -- Attack Skill Blueprint
INSERT INTO storage (type, wood, food, gold, stone) VALUES ('expense', 4, 2, 9, 0);   -- Defend Skill Blueprint
INSERT INTO storage (type, wood, food, gold, stone) VALUES ('expense', 6, 3, 12, 0);  -- Mail Armor Blueprint

-- Inserting records for the blueprints
INSERT INTO blueprint (name, description, research_time, storage_id) VALUES ('Spearmen Blueprint', 'A blueprint for creating Spearmen', 50, 1);
