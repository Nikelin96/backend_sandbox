...
public sealed class KingdomUnitRepository
{
    ...
    public async Task<int> Create(KingdomUnit unit)
    {
        ...
        var sql = @"INSERT INTO kingdom_unit (kingdom_id, unit_id, kingdom_transaction_id) VALUES (@KingdomId, @UnitId, @TransactionId) RETURNING id;";
    ...
    //public async Task<int> CreateWihViolation(KingdomUnit unit)
    //{
    //    using var connection = _connectionCreator.Create();
